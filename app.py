...
def _toggle_button(label: str, state_key: str, *, button_type: str = "secondary") -> bool:
    ...
    if st.button(label, key=f"btn_{state_key}", type=button_type, use_container_width=True):
...
def render_mobile_hub_panel(match_id: str, home_ko: str, away_ko: str):
    ...
    if sheet_url:
        st.link_button("구글시트 열기", sheet_url, use_container_width=True)
    else:
...
def main():
    ...
    render_pc_mobile_address_panel()
    render_metrics()
